        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="{{ url('') }}/frontend/index.html"><img
                            src="{{ url('') }}/frontend/assets/images/logo-2.png" alt=""
                            title=""></a></div>
                ...
                <div class="social-links">
                    <ul class="clearfix">
                        ...
                        <li><a href="{{ url('') }}/frontend/index.html"><span
                        ...
                        <div class="image_block_1">
                            <div class="image-box">
                                ...
                                <figure class="image image-2"><img
                                        src="{{ url('') }}/frontend/assets/images/resource/about-2.jpg"
                                        alt=""></figure>
                ...
                <div class="row clearfix">
                        ...
                        <div class="tour-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="{{ url('') }}/frontend/assets/images/tour/tour-1.jpg"
                                        alt="">
                                    <a href="{{ url('') }}/frontend/tour-details.html"><i
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 tour-block">
                        <div class="tour-block-one wow fadeInUp animated animated" data-wow-delay="300ms"
                            ...
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="{{ url('') }}/frontend/assets/images/tour/tour-2.jpg"
                                        alt="">
                                    <a href="{{ url('') }}/frontend/tour-details.html"><i
                                            class="fas fa-link"></i></a>
                                </figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 tour-block">
                        <div class="tour-block-one wow fadeInUp animated animated" data-wow-delay="600ms"
                            ...
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="{{ url('') }}/frontend/assets/images/tour/tour-3.jpg"
                                        alt="">
                                    <a href="{{ url('') }}/frontend/tour-details.html"><i
                                            class="fas fa-link"></i></a>
                                </figure>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 place-block">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ url('') }}/frontend/assets/images/resource/place-1.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 place-block">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ url('') }}/frontend/assets/images/resource/place-2.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 place-block">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ url('') }}/frontend/assets/images/resource/place-3.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 place-block">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ url('') }}/frontend/assets/images/resource/place-4.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="map-content clearfix">
                        <div class="single-location-box">
                            <figure class="map-marker">
                                <img src="{{ url('') }}/frontend/assets/images/icons/marker-1.png"
                                    alt="">
                                <span>1</span>
                            </figure>
                        ...
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="btn-box">
                                        <a href="{{ url('') }}/frontend/blog-details.html"
                                            class="theme-btn-two">See Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
