...
<!-- Google Fonts -->
<link href="{{url('')}}/frontend/https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
<link href="{{url('')}}/frontend/https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header style-one">
            ...
            <div class="header-lower">
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="{{url('')}}/frontend/index.html"><img src="assets/images/logo.png" alt=""></a></figure>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="current dropdown"><a href="{{url('')}}/frontend/index.html">Home</a>
                                            <ul>
                                                <li><a href="{{url('')}}/frontend/index.html">Home Page 01</a></li>
                                                <li><a href="{{url('')}}/frontend/index-2.html">Home Page 02</a></li>
                                                <li><a href="{{url('')}}/frontend/index-3.html">Home Page 03</a></li>
                                                <li><a href="{{url('')}}/frontend/index-4.html">Home Page 04</a></li>
                                                <li><a href="{{url('')}}/frontend/index-5.html">Home Page 05</a></li>
                                                <li><a href="{{url('')}}/frontend/index-onepage.html">OnePage Home</a></li>
                                                <li><a href="{{url('')}}/frontend/index-rtl.html">RTL Home</a></li>
                                                <li class="dropdown"><a href="{{url('')}}/frontend/index.html">Header Style</a>
                                                    <ul>
                                                        <li><a href="{{url('')}}/frontend/index.html">Header Style 01</a></li>
                                                        <li><a href="{{url('')}}/frontend/index-2.html">Header Style 02</a></li>
                                                        <li><a href="{{url('')}}/frontend/index-3.html">Header Style 03</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown"><a href="{{url('')}}/frontend/index.html">Destinations</a>
                                            <ul>
                                                <li><a href="{{url('')}}/frontend/destination.html">Destinations 01</a></li>
                                                <li><a href="{{url('')}}/frontend/destination-2.html">Destinations 02</a></li>
                                                <li><a href="{{url('')}}/frontend/destination-details.html">Destination Details</a></li>
                                            </ul>
                                        </li> 
                                        <li class="dropdown"><a href="{{url('')}}/frontend/index.html">Tours</a>
                                            <ul>
                                                <li><a href="{{url('')}}/frontend/tour-1.html">Tours Grid</a></li>
                                                <li><a href="{{url('')}}/frontend/tour-2.html">Tours List</a></li>
                                                <li><a href="{{url('')}}/frontend/tour-details.html">Tour Details</a></li>
                                            </ul>
                                        </li> 
                                        <li class="dropdown"><a href="{{url('')}}/frontend/index.html">Pages</a>
                                            <ul>
                                                <li><a href="{{url('')}}/frontend/about.html">About Us</a></li>
                                                <li><a href="{{url('')}}/frontend/booking-1.html">Booking Process</a></li>
                                                <li><a href="{{url('')}}/frontend/tour-deals.html">Tour Deals</a></li>
                                                <li><a href="{{url('')}}/frontend/tour-guide.html">Tour Guide</a></li>
                                                <li><a href="{{url('')}}/frontend/gallery-1.html">Gallery 01</a></li>
                                                <li><a href="{{url('')}}/frontend/gallery-2.html">Gallery 02</a></li>
                                                <li><a href="{{url('')}}/frontend/faq.html">Faq's</a></li>
                                                <li><a href="{{url('')}}/frontend/signup.html">Sign Up</a></li>
                                                <li><a href="{{url('')}}/frontend/login.html">Sign In</a></li>
                                                <li><a href="{{url('')}}/frontend/error.html">404</a></li>
                                            </ul>
                                        </li> 
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-xl-6 column">
                                                        <ul>
                                                            ...
                                                            <li><a href="{{url('')}}/frontend/about-element-1.html">About Block 01</a></li>
                                                            <li><a href="{{url('')}}/frontend/about-element-2.html">About Block 02</a></li>
                                                            <li><a href="{{url('')}}/frontend/about-element-3.html">About Block 03</a></li>
                                                            <li><a href="{{url('')}}/frontend/feature-element-1.html">Feature Block 01</a></li>
                                                            <li><a href="{{url('')}}/frontend/feature-element-2.html">Feature Block 02</a></li>
                                                            <li><a href="{{url('')}}/frontend/tour-element-1.html">Tour Block 01</a></li>
                                                            <li><a href="{{url('')}}/frontend/tour-element-2.html">Tour Block 02</a></li>
                                                            <li><a href="{{url('')}}/frontend/place-element-1.html">Place Block 01</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-xl-6 column">
                                                        <ul>
                                                            <li><h4>Elements 2</h4></li>
                                                            <li><a href="{{url('')}}/frontend/place-element-2.html">Place Block 02</a></li>
                                                            <li><a href="{{url('')}}/frontend/news-element-1.html">News Block 01</a></li>
                                                            <li><a href="{{url('')}}/frontend/news-element-2.html">News Block 02</a></li>
                                                            <li><a href="{{url('')}}/frontend/team-element-1.html">Team Block 01</a></li>
                                                            <li><a href="{{url('')}}/frontend/team-element-2.html">Team Block 02</a></li>
                                                            <li><a href="{{url('')}}/frontend/video-element.html">Video Block</a></li>
                                                            <li><a href="{{url('')}}/frontend/funfact-element.html">Funfact Block</a></li>
                                                            <li><a href="{{url('')}}/frontend/testimonial-element.html">Testimonial Block</a></li>
                                                        </ul>
                                                    </div>                                   
                                                </div>                                        
                                            </div>
                                        </li> 
                                        <li class="dropdown"><a href="{{url('')}}/frontend/index.html">Blog</a>
                                            <ul>
                                                <li><a href="{{url('')}}/frontend/blog.html">Blog Grid</a></li>
                                                <li><a href="{{url('')}}/frontend/blog-2.html">Blog Standard</a></li>
                                                <li><a href="{{url('')}}/frontend/blog-details.html">Blog Details</a></li>
                                            </ul>
                                        </li>  
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="{{url('')}}/frontend/index.html"><img src="assets/images/logo-2.png" alt="" title=""></a></div>
                        ...
                        <div class="image_block_1">
                            <div class="image-box">
                                ...
                                <div class="video-content">
                                    ...
                                    <div class="video-btn">
                                        <a href="{{url('')}}/frontend/https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s" class="lightbox-image" data-caption=""><i class="icon-Video"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content_block_1">
                            <div class="content-box">
                                ...
                                <div class="btn-box">
                                    <a href="{{url('')}}/frontend/tour-1.html" class="theme-btn">Find Tours</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="tour-section bg-color-1 sec-pad">
            ...
            <div class="auto-container">
                ...
                <div class="row clearfix">
                        ...
                        <div class="tour-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h3><a href="{{url('')}}/frontend/tour-details.html">Moscow Red City Land</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 tour-block">
                        <div class="tour-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 tour-block">
                        <div class="tour-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
            ...
            <div class="auto-container">
                <div class="content_block_2">
                    <div class="content-box">
                        ...
                        <div class="price"><h4>$150</h4><del>$300</del></div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 counter-block">
                            <div class="counter-block-one">
                                <div class="inner-box">
                                    <div class="pattern" style="background-image: url(assets/images/shape/shape-5.png);"></div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 counter-block">
                            <div class="counter-block-one">
                                <div class="inner-box">
                                    <div class="pattern" style="background-image: url(assets/images/shape/shape-7.png);"></div>
                                    <div class="count-outer count-box">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 counter-block">
                            <div class="counter-block-one">
                                <div class="inner-box">
                                    <div class="pattern" style="background-image: url(assets/images/shape/shape-8.png);"></div>
                                    <div class="count-outer count-box">
        ...
        <section class="video-section centred" style="background-image: url(assets/images/background/video-1.jpg);">
            <div class="auto-container">
                <div class="inner-box">
                    ...
                    <div class="video-btn">
                        <a href="{{url('')}}/frontend/https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s" class="lightbox-image" data-caption="">
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <a href="{{url('')}}/frontend/blog-details.html"><img src="assets/images/news/news-1.jpg" alt=""></a>
                                    <span class="post-date"><i class="icon-Calendar"></i>5 Oct, 2020</span>
                                </figure>
                                <div class="lower-content">
                                    <div class="category"><a href="{{url('')}}/frontend/blog-details.html">Lifestyle</a></div>
                                    <h3><a href="{{url('')}}/frontend/blog-details.html">Including animation in your design system</a></h3>
                                    <ul class="post-info clearfix">
                                        <li><span>By</span> <a href="{{url('')}}/frontend/index.html">Eva Green</a></li>
                                    ...
                                    <div class="btn-box">
                                        <a href="{{url('')}}/frontend/blog-details.html" class="theme-btn-two">See Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <a href="{{url('')}}/frontend/blog-details.html"><img src="assets/images/news/news-2.jpg" alt=""></a>
                                    <span class="post-date"><i class="icon-Calendar"></i>4 Oct, 2020</span>
                                </figure>
                                <div class="lower-content">
                                    <div class="category"><a href="{{url('')}}/frontend/blog-details.html">Lifestyle</a></div>
                                    <h3><a href="{{url('')}}/frontend/blog-details.html">Strategic & commercial with issues.</a></h3>
                                    <ul class="post-info clearfix">
                                        <li><span>By</span> <a href="{{url('')}}/frontend/index.html">Eva Green</a></li>
                                        <li> - October 13, 2020</li>
                                    </ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <a href="{{url('')}}/frontend/blog-details.html"><img src="assets/images/news/news-3.jpg" alt=""></a>
                                    <span class="post-date"><i class="icon-Calendar"></i>3 Oct, 2020</span>
                                </figure>
                                <div class="lower-content">
                                    <div class="category"><a href="{{url('')}}/frontend/blog-details.html">Lifestyle</a></div>
                                    <h3><a href="{{url('')}}/frontend/blog-details.html">Best interior design idea for your home.</a></h3>
                                    <ul class="post-info clearfix">
                                        <li><span>By</span> <a href="{{url('')}}/frontend/index.html">Eva Green</a></li>
                                        <li> - October 13, 2020</li>
                                    </ul>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><a href="{{url('')}}/frontend/index.html"><img src="assets/images/footer-logo.png" alt=""></a></figure>
                                <div class="text">
                                ...
                                <ul class="social-links clearfix">
                                    <li><a href="{{url('')}}/frontend/index.html"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="{{url('')}}/frontend/index.html"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="{{url('')}}/frontend/index.html"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="{{url('')}}/frontend/index.html"><i class="fab fa-google-plus-g"></i></a></li>
                                    <li><a href="{{url('')}}/frontend/index.html"><i class="fab fa-linkedin-in"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="links-list clearfix">
                                        <li><a href="{{url('')}}/frontend/index.html">About Us</a></li>
                                        <li><a href="{{url('')}}/frontend/index.html">Listing</a></li>
                                        <li><a href="{{url('')}}/frontend/index.html">How It Works</a></li>
                                        <li><a href="{{url('')}}/frontend/index.html">Our Services</a></li>
                                        <li><a href="{{url('')}}/frontend/index.html">Our Blog</a></li>
                                        <li><a href="{{url('')}}/frontend/index.html">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget gallery-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="image-list clearfix">
                                        <li><figure class="image-box"><a href="{{url('')}}/frontend/gallery-1.html"><img src="assets/images/resource/footer-gallery-1.jpg" alt=""></a></figure></li>
                                        <li><figure class="image-box"><a href="{{url('')}}/frontend/gallery-1.html"><img src="assets/images/resource/footer-gallery-2.jpg" alt=""></a></figure></li>
                                        <li><figure class="image-box"><a href="{{url('')}}/frontend/gallery-1.html"><img src="assets/images/resource/footer-gallery-3.jpg" alt=""></a></figure></li>
                                        <li><figure class="image-box"><a href="{{url('')}}/frontend/gallery-1.html"><img src="assets/images/resource/footer-gallery-4.jpg" alt=""></a></figure></li>
                                        <li><figure class="image-box"><a href="{{url('')}}/frontend/gallery-1.html"><img src="assets/images/resource/footer-gallery-5.jpg" alt=""></a></figure></li>
                                        <li><figure class="image-box"><a href="{{url('')}}/frontend/gallery-1.html"><img src="assets/images/resource/footer-gallery-6.jpg" alt=""></a></figure></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="info-list clearfix">
                                        ...
                                        <li><i class="fas fa-microphone"></i><a href="{{url('')}}/frontend/tel:23055873407">+2(305) 587-3407</a></li>
                                        <li><i class="fas fa-envelope"></i><a href="{{url('')}}/frontend/mailto:info@example.com">info@example.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="auto-container">
                    <div class="bottom-inner clearfix">
                        <div class="copyright pull-left">
                            <p><a href="{{url('')}}/frontend/index.html">Travio</a> &copy; 2021 All Right Reserved</p>
                        </div>
                        <ul class="footer-nav pull-right">
                            <li><a href="{{url('')}}/frontend/index.html">Terms of Service</a></li>
                            <li><a href="{{url('')}}/frontend/index.html">Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
            </div>
